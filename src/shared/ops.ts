...
export const PALETTE_GROUPS: { caption: string; kinds: readonly PaletteKind[] }[] = [
  ...
  { caption: "Baits", kinds: ["stack", "tower", "linestack", "flare"] },
...
export const PALETTE_HINT: Record<PaletteKind, string> = {
  ...
  stack: "A stack on somebody: a number of people share it. Set how many in the inspector.",
  tower: "A tower to soak: it wants a set number of people standing in it. Set how many in the inspector.",
...
const PALETTE_BAIT: Record<PaletteMechanicKind, { kind: BaitKind; props: PropBag }> = {
  ...
  stack: { kind: "stack", props: { radius: 160, soak: 4 } },
  tower: { kind: "tower", props: { radius: 140, soak: 1 } },
...
const PALETTE_FREE: Record<PaletteKind, PropBag & { type: EntityType }> = {
  ...
  stack: { type: "zone", shape: "stack", radius: 160, soak: 4 },
  tower: { type: "zone", shape: "tower", radius: 140, soak: 1 },
