/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1d06c439ddbd4be3d6a933dd4c5f97ef)
// Runtime types generated with workerd@1.20260811.1 2026-08-01 nodejs_compat
interface __BaseEnv_Env {
	BACKGROUNDS: KVNamespace;
	ASSETS: Fetcher;
	DEV_AUTH: string;
	PlanAgent: DurableObjectNamespace<import("./src/server/index").PlanAgent>;
	Registry: DurableObjectNamespace<import("./src/server/index").Registry>;
	RaidPlanMCP: DurableObjectNamespace<import("./src/server/index").RaidPlanMCP>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server/index");
		durableNamespaces: "PlanAgent" | "Registry" | "RaidPlanMCP";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEV_AUTH">> {}
}
